...
import { RegisterAgentBodySchema, SelfRegisterBodySchema } from "./validation";
...
const createApp = (
  ...
  // --- Messaging (handler extracted to message-handler.ts) ---

  app.post("/messages", async (c) => {
    return handleMessage(c, { registry, activity, inbox, messageStore });
  });
